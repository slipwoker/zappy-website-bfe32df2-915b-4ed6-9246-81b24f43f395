            ...
            if (isValid) {
                ...
                .then(function(response) {
                    if (response.ok) {
                        ...
                        successMessage.style.cssText = 'color: #38a169; font-size: 0.875rem; margin-top: 1rem;';
                ...
                .catch(function(error) {
                    ...
                    errorMessage.style.cssText = 'color: #e53e3e; font-size: 0.875rem; margin-top: 1rem;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'bfe32df2-915b-4ed6-9246-81b24f43f395',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'bfe32df2-915b-4ed6-9246-81b24f43f395';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'bfe32df2-915b-4ed6-9246-81b24f43f395';
